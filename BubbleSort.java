...
public class BubbleSort{
    ...
    public static void saveArrayToFile(String filename) throws IOException{
        FileWriter writer = new FileWriter(filename);
        for (int i = 0; i < readarr.length; i++){
            writer.write(Integer.toString(readarr[i]));
            if (i < readarr.length - 1) {
                writer.write("\n");
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (choice.equals("F")){
            ...
            java.util.Scanner savescanner = new Scanner(System.in);
            System.out.println("Enter a file to write your sorted array in:");
            String file = savescanner.nextLine();
